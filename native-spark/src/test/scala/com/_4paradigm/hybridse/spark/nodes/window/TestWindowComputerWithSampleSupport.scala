...
import com._4paradigm.hybridse.spark.{NativeSparkConfig, SparkPlanner, SparkRowCodec, SparkTestSuite}
...
class TestWindowComputerWithSampleSupport extends SparkTestSuite {
  ...
  test("Test sample window data") {
    ...
    val samplePath = "src/test/resources/native_spark_windows/"
