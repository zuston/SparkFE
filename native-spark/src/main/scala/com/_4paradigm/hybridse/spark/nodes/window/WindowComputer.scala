...
import com._4paradigm.hybridse.spark.{NativeSparkConfig, SparkRowCodec}
import com._4paradigm.hybridse.spark.nodes.WindowAggPlan.WindowAggConfig
import com._4paradigm.hybridse.spark.utils.{HybridseUtil, SparkRowUtil}
...
/**
  ...
  */
class WindowComputer(sqlConfig: NativeSparkConfig,
