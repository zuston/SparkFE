...
object WindowSampleSupport {
  ...
  class SampleExecutor(sqlConfig: NativeSparkConfig, val config: WindowAggConfig) {
  ...
  def recover(sqlConfig: NativeSparkConfig, path: String, windowIdx: Int): SampleExecutor = {
